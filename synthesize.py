...
from configs.personalize_0831 import create_hparams
...
stft = TacotronSTFT(hparams.filter_length, hparams.hop_length, hparams.win_length,
                    ...
                    hparams.mel_fmax)
speaker = "ada"
checkpoint_path = '/mnt/sdc1/personalize_tts_for_selvas2/adapt/ada2/checkpoint_327300'
...
# test_text_path = 'filelists/personalize/test_add2.txt'
test_text_path='/home/admin/projects/personalize_tts/filelists/dummy_ref5.txt'
...
speaker_ids = TextMelLoader(hparams.adapt_files, hparams).speaker_ids
...
for i, batch in enumerate(dataloader):
    ...
    with torch.no_grad():
        mel_outputs, mel_outputs_postnet, gate_outputs, rhythm = model.inference(x)
    ...
    with torch.no_grad():
        ...
        for j in range(len(audio)):
            ...
            path="/mnt/sdc1/personalize_tts_for_selvas2/327000/ada/sample-{:03d}_target_speaker-{}-1218.wav".format(i*hparams.batch_size+j+1, speaker)
